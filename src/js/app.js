import Ddslick from './lib/ddslick.js';
import Accordion from './lib/accordion.js';
import './lib/hamburgerNav.js';
import './lib/slick.js';
import 'cleave.js';
import './lib/cleaveInputs.js';
...
$('#select-apartments').ddslick({});
$('#select-plan').ddslick({});
$('#select-bathrooms').ddslick({});

$('#select-city--bt').ddslick({});
$('#select-apartments--bt').ddslick({});
$('#select-plan--bt').ddslick({});
$('#select-bathrooms--bt').ddslick({});

// paymant page
$('#waycontact').ddslick({});

// paymant page
$('#form__howget').ddslick({});
// end calling Ddslick

// booking almost page
(function($) {
  var formDiscountInput = $("#form-discount-input");
  var btnDiscountApply = $("#btn-discount-apply");
  $(formDiscountInput).focusin(function() {
    $(btnDiscountApply).css("opacity", "1")
  });
  $(formDiscountInput).focusout(function() {
    if (this.value == '') {
      $(btnDiscountApply).css("opacity", "0.6")
    } else {
      $(btnDiscountApply).css("opacity", "1")
    }
  });
...
function Datepickk(args) {
  ...
  if (wid > 480) {
    languages.en.dayNames = ['sunday', 'monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday'];
  }
...
var getBrowserVersion = function() {
  ...
  // Datepickk http://crsten.github.io/datepickk/
const datepick = document.querySelector('#datepickker');
if (datepick) {
  var previosDates = {
  ...
  var datepicker = new Datepickk({
    container: document.querySelector('#datepickker'),
    inline: true,
    // highlight: [previosDates],
    maxSelections: 1,
